...
$title = "Backup Strike Summary Report ( Non Prod SQL servers)"
...
$html += '</table>
<p style="margin-top: 15px; margin-bottom: 15px;"><span style="font-size:1em;">Backup Strike Summary Reports From ALL cluster</span></p>               
</div>
</body>
</html>
'
...
$fileName = "./strikeReport_sql_non_prod.html"
