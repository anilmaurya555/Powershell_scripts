...
param (
    ...
    [Parameter()][string]$domain = 'ent.ad.ntrs.com'
)
...
$html += '</span>
<span style="font-size:0.75em; text-align: right; padding-top: 8px; padding-right: 2px; float: right;width:50%">'
#$html += $date
...
$html += '</span>
                ...
                <tr style=padding-left: 5px; font-size:15px>
                        ...
                        <th>Client Nmae</th>
                        <th>Backup Type</th>
                        <th>Protected By Jobs</th>
                        </tr>'

#$vips = ('chyusnpccp01','chyuswpccp01')
#$vips = ('chyusnpccp02')
$vips = ('chyididcp01','chymaidcp01','chysgpccp01','chysgrccp01','chyukpccp01','chyukrccp01','chyusnpccp01','chyuswpccp01','chyusnpccp02','chyuswpccp02','chyusnpccp03','chyuswpccp03','chyusnpccp05','chyuswpccp05')

foreach ($vip in $vips){

######## html tag for cluster #######
$html += "
...
"`nCollecting Report of Objects Protected by $vip..."
...
foreach ($source in ($namedSources.Keys | Sort-Object )){
    ...
    ##########HTML tag for client name #########
    $html += "
                                                 <td></td>
                                                 <td>$source</td>
                                                 <td>$($environments[$source])</td>
                                                 <td></td>
                                                 </tr>"

    foreach ($jobName in ($namedSources[$source] | Sort-Object)){
        "`t" + $jobName
        ############# HTML Tag for job names #####333
       $html += "
                                                 <td></td>
                                                 <td></td>
                                                 <td></td>
...
$html | out-file "RedundantProtectionReport.html"
$htmlfimename = "RedundantProtectionReport.html"
