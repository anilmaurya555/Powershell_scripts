...
<tbody>
<tr>
<td bgcolor="#CC9999" valign="top" align="center" border="0" width="200"><font size="1">Aged</font></td>
...
$outFilePath = join-path -Path $PSScriptRoot -ChildPath 'smtphtml.html'
$html | Out-File -FilePath 'smtphtml.html' -Encoding ascii
