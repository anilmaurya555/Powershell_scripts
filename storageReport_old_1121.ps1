...
function td($data, $wrap='', $align='LEFT'){
    '<td ' + $wrap + ' colspan="1" valign="top" align="' + $align + '" border="0"><font size="2">' + $data + '</font></td>'
}
...
$html += '</table> 
<p style="margin-top: 15px; margin-bottom: 15px;"><span style="font-size:1.3em;">Total physical space consumed (GiB Consumed) in TB: ' + $alltotal + '</span></p>
