...
$title = "Cohesity Restore Report ($start - $end)"
...
### authenticate
apiauth -vip $cluster -username $username -domain ent.ad.ntrs.com
$html += "<td style='padding-left: 5px; font-size:15px; color:#32B232'>$cluster</td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
