...
"===========  collecting obejectIds ==============="
if ($vip -notin $allobjectids.keys){
                    $allobjectids[$vip] = @{}
                                    }
...
$sources = api get protectionSources
    ...
    function get_nodes($obj){
           ...
           if ($obj.protectionSource.id){
            $object_id = $obj.protectionSource.id
            $object = $obj.protectionSource.name
            if ( $object -notin $allobjectids[$vip].keys){
                               $allobjectids[$vip][$object] = $object_id
                                                         }
